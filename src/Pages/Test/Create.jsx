...
import { createContent, addThumbnail, getThumbnail, removeThumbnail } from "./httpService";
...
const Create = () => {
  ...
  const { isLoading, isError } = useAxios(`http://localhost:3000/posts`, 'Create New Article | Blog PCC');
  ...
  const onSubmit = () => {
    setUpdateAt(new Date().toDateString());
    var data = {
      title: title.value,
        ...
        <div className="w-full md:w-6/12 flex justify-center">
          <form onSubmit={handleSubmit(onSubmit)} className="bg-white w-full shadow-md rounded px-8 pt-6 pb-8 mb-4">
            ...
            <div className="mb-6">
              ...
              <input type="text" {...headline} className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="headline" />
            ...
            <div className="mb-6">
              ...
              <div className="mt-2">
                <label className="inline-flex items-center">
                  <input type="radio" className="form-radio" value="networking" {...category} />
                  <span className="ml-2 text-gray-700 ">Networking</span>
                </label>
                <label className="inline-flex items-center ml-6">
                  <input type="radio" className="form-radio" value="programming" {...category} />
                  <span className="ml-2 text-gray-700 ">Programming</span>
                </label>
                <label className="inline-flex items-center ml-6">
                  <input type="radio" className="form-radio" value="design" {...category} />
              ...
              <div className="overflow-x-auto">
                ...
                <div className="inline-flex">
                  <div className="text-center">
                    <label className="rounded block mb-3 py-12 text-center cursor-pointer text-gray-600 hover:text-blue-600 opacity-50 border-solid border-2 border-gray-400 hover:border-blue-400" style={{ height: '180px', width: '200px' }}>
